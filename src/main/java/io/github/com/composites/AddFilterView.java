...
public class AddFilterView extends Section {
    @JDropdown(root = "[class*=entities-selector]", value = "[class*=entitiesSelector__toggler]",
            list = "[class*=entitiesSelector__entities-list] span", expand = "[class*=entitiesSelector__toggler]")
    public static Dropdown moreDropdown;
